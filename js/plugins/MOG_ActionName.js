...
/*:
 * @plugindesc (v1.1) Apresenta uma janela com nome da ação.
 * @author Moghunter
 *
 * @param Layout X-Axis
...
// * create Action Name
//==============================
Spriteset_Map.prototype.createActionName = function() {
...
// * create Action Name
//==============================
Spriteset_Battle.prototype.createActionName = function() {
	this._spriteSkillName = new SpriteSkillName();
    this.addChild(this._spriteSkillName);
};
