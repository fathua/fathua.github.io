...
//=============================================================================
/*:
 * @plugindesc 【Q+】务必放在所有Q插件之上；一些MV的小改动为了便于插件的开发。<QPlus> (Should go above all Q Plugins)
 * Some small changes to MV for easier plugin development.
 * @version 1.7.1
 * @author Quxios 中英翻译：kaidy | Version 1.7.1
 ...
 *
 * @param Quick Test
 * @desc 当为true，游戏讲跳过标题界面并开始一个新的游戏
 * When true, game will skip title screen and start a new game
 * @type Boolean
 * @default true
 *
 * @param 默认启用开关
 ...
 * When true, the game window will ignore mouse input when the game
 ...
 * 这个是Q插件中最核心的插件。它还为RMMV改良它而增加了一些新功能。
 *
 * ============================================================================
 * ## Notetags / Comments
 * ============================================================================
 ...
 * 添加在notes下或comment之中将使事件在更改页面时保持其方向。
 * ~~~
 * <retainDir>
 * ~~~
