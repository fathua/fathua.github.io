 ...
 * 添加多个图片到标题菜单前
 * 需要准备以下命名格式的图片文件
 *Splash_INDEX.png（index替换为1，2等数字）
 * 将图片文件依次编号
 *Splash_0.png
 * Splash_1.png
 *Splash_2.png
 ...
 * img/titles2/
 * 设置项目
 *Splash Frames=插入图片张数
 * Slash Duration=图片显示帧数
 *Splash Fade Duration=渐变速度，越高越快
 * Full Screen Mode=全屏显示
 */
