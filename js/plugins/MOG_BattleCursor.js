...
/*:
 * @plugindesc (v2.0) Adiciona flechas de indicação nos alvos selecionados.
 * @author Moghunter
 *
 * @param X-Axis
 ...
 * HISTÓRICO
 * ============================================================================
 * (v2.0) - Melhoria na codificação e na compatibilidade de plugins. 
 */
...
// * Create Lower Layer
//==============================
var _mog_battleCursor_createLowerLayer = Spriteset_Battle.prototype.createLowerLayer;
Spriteset_Battle.prototype.createLowerLayer = function() {
	_mog_battleCursor_createLowerLayer.call(this);	
